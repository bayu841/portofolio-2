    ...
    >
      ...
      <div>
        ...
        <p class="font-bold text-gray-700 text-lg leading-relaxed mb-8">
          Punya project, ide, atau ingin bekerja sama? Silahkan hubungi saya
        ...
        <div class="flex flex-col gap-5">
          ...
          >
            ...
            <p class="font-bold text-gray-700">ardiansyahbayu722@gmail.com</p>
          </div>
          ...
          >
            ...
            <p class="font-bold text-gray-700">Indonesia</p>
          </div>
        </div>
      </div>
